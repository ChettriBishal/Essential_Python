...
"""
You can configure the output to include more than just the level and the logger used. 
You can add for example the time:
"""
...
Of course, as you go through your Python journey you may encounter situations where 
using a differently-configured logger would be better. 
Or when you’ll work with people who want logging in a particular way.

You’ll then have to decide how you want to log things, 
and as most things in software that should be a team decision.
"""
...
"""
If you call `logging.getLogger('my_app')` from many different files, 
you’ll always get the same `Logger` object—so any configuration changes 
and the handler added will be reflected throughout all the app.
...
"""
Add logging to your projects moving forward! 
It’s great when you can trace what was happening in your system as it happened with extensive logs 
(although, it does mean the code will be longer since you need to include logging statements ever   ywhere).
"""
