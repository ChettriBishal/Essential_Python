...
class BinaryTree:
    ...
    # to get the largest node in the subtree
    ...
    def delete(self, value: int):
        ...
        if to_delete.left and to_delete.right:
        ...
        elif to_delete.left or to_delete.right:  # has one child
            if to_delete == to_delete_parent.left:
            ...
            if to_delete == to_delete_parent.left:  # left child of the parent
                to_delete_parent.left = None
            elif to_delete == to_delete_parent.right:  # right child of the parent
